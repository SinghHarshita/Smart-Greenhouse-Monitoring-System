          ...
          <div className="main-container">
            ...
            <div className="content-container" ref={(x) => { this.home = x; }}>
              <div className="section home subpage">
                <Container>
                  <SubHero title={messages["lp.blogdetail.title"]} detail={messages["lp.blogdetail.detail"]} >
                  </SubHero>
                  <Row>
                    ...
                    <Colxx xxs="12" lg="7">
                      <Card>
                        <CardBody className="p-0">
                          <img alt="subpage" src="/assets/img/landing-page/subpage-image.jpg" className="img-fluid card-img-fluid" />
                        </CardBody>
                      </Card>

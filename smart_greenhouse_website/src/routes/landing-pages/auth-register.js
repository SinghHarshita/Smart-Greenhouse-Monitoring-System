                    ...
                    <Colxx xxs="12" lg="6" xl="4" md="12">
                      <div className="home-text">
                        <div className="display-1">
                          <IntlMessages id="lp.register.title" />
                        </div>
                        <p className="white mb-5">
                          <IntlMessages id="lp.register.detail-1" />{" "}
                          <NavLink className="white-underline-link" to="/auth-login">
                            <IntlMessages id="lp.register.login" />.
                          </NavLink>
                        </p>
                        ...
                        <Form className="dark-background">
                          ...
                          <Button color="empty" className="btn-outline-semi-light mt-4" size="xl">
...
export default connect(mapStateToProps, {landingPageMobileMenuToggle,landingPageMobileMenuClose})(injectIntl(AuthRegister))
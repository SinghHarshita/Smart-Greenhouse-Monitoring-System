                ...
                <Container>
                  ...
                  <Row className="mt-4">
                    <Colxx xxs="12" md="6" className="mb-3">
                      <img alt="library app" className="depth-1 img-fluid semi-rounded" src="/assets/img/landing-page/application-library.jpg" />
                    </Colxx>
                    <Colxx xxs="12" md="6" className="mb-3">
...
export default connect(mapStateToProps, {landingPageMobileMenuToggle,landingPageMobileMenuClose})(injectIntl(DocsDetail))